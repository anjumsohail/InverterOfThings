...
*/
    ...
    bool _valid = false;
    /*
    String _wifiSsid = "Anjum";
    String _wifiPass = "29742974";
  
    String _deviceType = "PIP";
    String _deviceName = "SetSolar";
    String _mqttServer = "a0751266.us-east-1.emqx.cloud";
    short _mqttPort = 15563;
    String _mqttUser = "itdanjum";
    String _mqttPassword = "allah786";
    */
    String _DebugLog = "";
    ...
    String _deviceType = "PIP";
    String _deviceName = "SetSolar";
    String _mqttServer = "mqtt.thingspeak.com";
    short _mqttPort = 1883;
    String _mqttUser = "itdanjum";
    String _mqttPassword = "8X32NB8M8V05PD9M";
    short  _updateRateSec = 30;
    short _BufferSize = 5000;
...
Serial.println(s);
    ...
    void load()
    {
      ...
      if (_valid)
      {
       ...
       _mqttPort = readShort(0x100);
        _updateRateSec = readShort(0x120);
      }
    ...
    void save()
    {
      ...
      writeShort(_updateRateSec, 0x120);
